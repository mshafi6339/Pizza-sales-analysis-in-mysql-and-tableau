...
-- Problem: For each individual order, identify the pizza category that contributed the most to the total quantity of pizzas ordered in that specific order.
select *  from pizzas , orders , order_details , pizza_types;
